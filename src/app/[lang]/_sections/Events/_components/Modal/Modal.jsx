  ...
  return (
    ...
    >
      {isModalOpen && selectedEvent ? (
        <div className="relative bg-white max-h-[75vh] lg:max-h-[85vh] lg:max-w-3xl xl:max-w-4xl text-center grid place-items-center pt-8 pb-2 px-6 rounded-md overflow-scroll">
          {/* Title */}
