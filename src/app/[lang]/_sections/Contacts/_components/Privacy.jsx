...
const Privacy = ({ fetchedData4 }) => {
  const variants = {
    hidden: { x: '100%', opacity: 0 },
    visible: { x: 0, opacity: 1 },
  };

  const { title } = fetchedData4;
  ...
  return (
    ...
    >
      ...
      <h3 className="m-2 text-2xl">1. Datenschutz auf einen Blick</h3>
      <h4 className="m-2 text-xl">Allgemeine Hinweise</h4>{' '}
      ...
      <h4 className="m-2 text-xl">Datenerfassung auf dieser Website</h4>{' '}
      ...
      <h4 className="m-2 text-xl">Wie erfassen wir Ihre Daten?</h4>{' '}
      <p className="text-gray-800 mt-2 mb-4">
      ...
      <h4 className="m-2 text-xl">Wof&uuml;r nutzen wir Ihre Daten?</h4>{' '}
      <p className="text-gray-800 mt-2 mb-4">
      ...
      <h4 className="m-2 text-xl">2. Hosting</h4>
      <p className="text-gray-800 mt-2 mb-4">
        Wir hosten die Inhalte unserer Website bei folgendem Anbieter:
      </p>
      <h4 className="m-2 text-xl">Externes Hosting</h4>{' '}
      <p className="text-gray-800 mt-2 mb-4">
      ...
      <h4 className="m-2 text-xl">Datenschutz</h4>{' '}
      <p className="text-gray-800 mt-2 mb-4">
      ...
      <h4 className="m-2 text-xl">Hinweis zur verantwortlichen Stelle</h4>{' '}
      <p className="text-gray-800 mt-2 mb-4">
      ...
      <h4 className="m-2 text-xl">Speicherdauer</h4>{' '}
      <p className="text-gray-800 mt-2 mb-4">
      ...
      <h4 className="m-2 text-xl">Empfänger von personenbezogenen Daten</h4>{' '}
      <p className="text-gray-800 mt-2 mb-4">
      ...
      <h4 className="m-2 text-xl">Auskunft, Berichtigung und L&ouml;schung</h4>{' '}
      <p className="text-gray-800 mt-2 mb-4">
      ...
      <h4 className="m-2 text-xl">SSL- bzw. TLS-Verschl&uuml;sselung</h4>{' '}
      <p className="text-gray-800 mt-2 mb-4">
      ...
      <h4 className="m-2 text-xl">4. Datenerfassung auf dieser Website</h4>
      <h4 className="m-2 text-xl">
